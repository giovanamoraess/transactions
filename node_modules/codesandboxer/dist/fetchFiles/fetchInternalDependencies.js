...
var _resolveFilePath = require('./resolveFilePath');

var _resolveFilePath2 = _interopRequireDefault(_resolveFilePath);
...
exports.default = function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _loop = function _loop(f) {
              files[(0, _resolveFilePath2.default)(f.path)] = { content: f.file };
          ...
          case 24:
            moreInternalImports = moreInternalImports.filter(function (mpt) {
              return !files[(0, _resolveFilePath2.default)(mpt)];
            });
  ...
  function fetchInternalDependencies(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
